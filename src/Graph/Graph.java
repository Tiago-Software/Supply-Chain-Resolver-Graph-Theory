...
public class Graph<T extends Comparable<T>> {
    ...
    public Graph(TYPE type, Collection<Vertex<T>> vertices, Collection<Edge<T>> edges) {
        ...
        for (Edge<T> e : edges) {
            ...
            if (this.type == TYPE.UNDIRECTED) {
                ...
                this.getAllEdges().add(reciprical);
            }
        }
    }
    ...
    @Override
    public int hashCode() {
        int code = this.type.hashCode() + this.allVertices.size() + this.getAllEdges().size();
    ...
    public boolean equals(Object g1) {
        ...
        final boolean edgesSizeEquals = this.getAllEdges().size() == g.getAllEdges().size();
        if (!edgesSizeEquals)
            return false;
        ...
        final Object[] oe1 = this.getAllEdges().toArray();
        Arrays.sort(oe1);
        final Object[] oe2 = g.getAllEdges().toArray();
        Arrays.sort(oe2);
